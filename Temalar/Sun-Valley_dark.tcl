...
# A stunning Sun-Valley_dark theme for ttk based on Microsoft's Sun Valley visual style 

package require Tk 8.6

namespace eval ttk::theme::Sun-Valley_dark {
    variable version 1.0
    package provide ttk::theme::Sun-Valley_dark $version

    ttk::style theme create Sun-Valley_dark -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] Sun-Valley_dark]
